...
enum class ErrorMessage(val message: String) {
    ...
    ACCOUNT_CREATION_PARAMS_REQUIRED("Please input a valid accountName and currency."),
    ...
    TRANSACTION_OPERATION_PARAMS_REQUIRED("Please input a valid amount and currency."),
